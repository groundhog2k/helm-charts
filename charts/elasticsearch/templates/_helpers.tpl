...
{{/*
Elasticsearch settings via environment variables
*/}}
{{- define "elasticsearch.environment" -}}
{{- if .Values.settings.javaOpts }}
- name: ES_JAVA_OPTS
  value: {{ .Values.settings.javaOpts | quote }}
{{- end }}
{{- if .Values.settings.discoveryType }}
- name: discovery.type
  value: {{ .Values.settings.discoveryType | quote }}
{{- end }}
{{- if .Values.settings.clusterName }}
- name: cluster.name
  value: {{ .Values.settings.clusterName | quote }}
{{- end }}
{{- end }}
