...
![Version: 2.4.6](https://img.shields.io/badge/Version-2.4.6-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 8.10.0](https://img.shields.io/badge/AppVersion-8.10.0-informational?style=flat-square)
...
| metrics.exporter.image.tag | string | `"v1.84.0"` | Image tag |
